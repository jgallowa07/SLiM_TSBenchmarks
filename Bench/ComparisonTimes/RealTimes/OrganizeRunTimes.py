...
axarr[0].plot(P,timing_data['rel_timing_N1000'],'mo--',label=PopSizes[0] + ' SLiM 2.6') 
axarr[0].plot(P,timing_data['rel_timing_N10000'],'c^--',label=PopSizes[1] + ' SLiM 2.6') 
...
axarr[1].plot(P,timing_data['pedNM_timing_N1000'],'mo--',label=PopSizes[0] + ' [recordMutations = F]') 
axarr[1].plot(P,timing_data['pedNM_timing_N10000'],'c^--',label=PopSizes[1] + ' [recordMutations = F]') 
